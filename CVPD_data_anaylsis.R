...
rawdata_disease_reports <- read_csv(
  "C:\\Users\\kaths\\Documents\\Career Development\\Educational Programs\\Hack the Gap Data Analyst\\R\\NNDSS\\NNDSS_Weekly_Data_20251030.csv") #Raw dataset for reference

disease_reports <- read_csv(
  "C:\\Users\\kaths\\Documents\\Career Development\\Educational Programs\\Hack the Gap Data Analyst\\R\\NNDSS\\NNDSS_Weekly_Data_20251030.csv") #Dataset for modifcations
head(disease_reports) #Short summary of the data

##U.S. State Populations
statepopulation <- read_csv(
  "C:\\Users\\kaths\\Documents\\Career Development\\Educational Programs\\Hack the Gap Data Analyst\\R\\NNDSS\\statepopulation_dataset.csv") #Raw dataset for reference
...
write.csv(CVPD_staterates, "CVPDstate_by_year.csv", row.names = FALSE)
...
write.csv(CVPD_nationalrates, "CVPDnational_by_year.csv", row.names = FALSE)
